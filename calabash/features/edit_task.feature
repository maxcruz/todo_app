Feature: Edit task
    ...
    Scenario: As a user I want to add a new task so that edit it
    ...
    Given I press "Task1"
    And I press "fabEditTask"
    And I enter "Edited" into input field number 1
    And I enter "Edited" into input field number 2
    And I press "fabAddTask"
    Then I should see "Task1Edited"   
